...
Maximum number of simultaneous processes per user id: 61340
Number of clock ticks (jiffy) per second: 100
Maximum number of open files: 1024
Size of a memory page: 4096 bytes
Total number of pages in physical memory: 3943596
Number of currently available pages in physical memory: 2046250
============================================================================
*/